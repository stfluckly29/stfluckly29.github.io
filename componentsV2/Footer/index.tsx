  ...
  return (
    ...
    >
      ...
      <HStack spacing={['10px', '20px', '20px', '20px']}>
        <ChakraLink isExternal href="https://github.com/stfluckly29" title="Github">
          <Image
        ...
        <ChakraLink isExternal href="mailto:stefanklein1130@gmail.com" title="Email">
          <Image
        ...
        <ChakraLink isExternal href="https://linkedin.com/in/stefan-klein-541460119" title="Linkedin">
          <Image
